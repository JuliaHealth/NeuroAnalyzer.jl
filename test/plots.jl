...
p = plot_locs(
    e10;
    ch="eeg",
    connections=rand(-10:1:10, 19, 19),
    threshold=12,
    threshold_type=:g,
    gui=false,
)
...
p = plot_filter_response(;
    fs=sr(eeg), fprototype=:butterworth, ftype=:hp, cutoff=10, order=8
)
@test p isa GLMakie.Figure
...
coh, imcoh, mscoh, f = coherence(
    e10, e10; ch1=["Fp1", "Fp2"], ch2=["Fp1", "Fp2"], ep1=1, ep2=1, flim=(15, 25)
)
