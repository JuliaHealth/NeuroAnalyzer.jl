...
@info "test 9/25: plot_spectrogram()"
...
@info "test 23/25: plot_erop()"
p, f = erop(e10, ch=1)
p = NeuroAnalyzer.plot_erop(p, f)
@test p isa Plots.Plot{Plots.GRBackend}

@info "test 24/25: plot(obj1, obj2)"
p = NeuroAnalyzer.plot(e10, e10, ch=1)
@test p isa Plots.Plot{Plots.GRBackend}

@info "test 25/25: plot_icatopo()"
