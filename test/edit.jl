...
@info "test 1/29: get_channel_type() / set_channel_type()"
...
@info "test 14/29: extract_channel()"
eeg = import_edf(joinpath(testfiles_path, "eeg-test-edf.edf"))
e10 = epoch(eeg, ep_len=10)
s = extract_channel(e10, ch=1)
@test size(s) == (1, 2560, 120)

@info "test 15/29: extract_epoch()"
...
@info "test 16/29: extract_data()"
d = extract_data(e10)
@test size(d) == (23, 2560, 120)

@info "test 17/29: extract_time()"
tpts = extract_time(e10)
@test length(tpts) == 307200

@info "test 18/29: extract_eptime()"
