...
@info "Test 10/$ntests: keep_epoch()"
...
@info "Test 13/$ntests: epoch_time()"
eeg = import_edf(joinpath(testfiles_path, "eeg-test-edf.edf"))
e10 = epoch(eeg, ep_len=10)
...
@info "Test 18/$ntests: extract_eptime()"
et = extract_eptime(e10)
@test length(et) == 2560

@info "Test 19/$ntests: trim()"
s = collect(1:100)
...
@info "Test 20/$ntests: delete_marker()"
...
@info "Test 26/$ntests: create_object()"
...
@info "Test 29/$ntests: delete_optode()"
