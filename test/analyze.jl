...
@info "test 20/52: ica_reconstruct()"
ic, ic_mw = NeuroAnalyzer.ica(rand(10, 1000), n=5, tol=1.0)
...
@info "test 27/52: pca_reconstruct()"
pc, pcv, pcm, pc_model = NeuroAnalyzer.pca(rand(4, 4, 2), n=2)
...
@test size(maxamp_at(e, t=(2, 2.5))) == (19, 123)

@info "test 52/52: minamp_at()"
@test size(minamp_at(e, t=(2, 2.5))) == (19, 123)
