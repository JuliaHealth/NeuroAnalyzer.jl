...
@info "test 15/55: erp_peaks()"
e = NeuroAnalyzer.erp(e10)
p = NeuroAnalyzer.erp_peaks(e)
@test size(p) == (19, 2)

@info "test 16/55: fcoherence()"
...
@info "test 20/55: ica_reconstruct()"
ic, ic_mw = NeuroAnalyzer.ica(rand(10, 1000), n=5, tol=1.0)
...
@info "test 25/55: mutual_information()"
...
@info "test 27/55: pca_reconstruct()"
pc, pcv, pcm, pc_model = NeuroAnalyzer.pca(rand(4, 4, 2), n=2)
