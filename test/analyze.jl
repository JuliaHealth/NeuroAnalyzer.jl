...
@info "test 15/59: erp_peaks()"
e = NeuroAnalyzer.erp(e10)
p = NeuroAnalyzer.erp_peaks(e)
@test size(p) == (23, 2)

@info "test 16/59: coherence()"
...
@info "test 25/59: mutual_information()"
...
@info "test 46/59: pacor()"
pac, l = pacor(e10, l=2)
@test size(pac) == (23, 5, 10)
@test length(l) == 5

@info "test 47/59: xcov()"
