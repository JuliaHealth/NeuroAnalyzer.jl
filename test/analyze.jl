...
@info "test 28/ : phdiff()"
@test NeuroAnalyzer.phdiff(a1, avg=:phase) == zeros(2, 3, 2)
@test NeuroAnalyzer.phdiff(a1, avg=:signal) == zeros(2, 3, 2)
p = NeuroAnalyzer.phdiff(e10) 
