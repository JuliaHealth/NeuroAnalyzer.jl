...
@info "test 15/47: erp_peaks()"
p = NeuroAnalyzer.erp_peaks(e10)
@test size(p) == (19, 2)

@info "test 16/47: fcoherence()"
...
@info "test 20/47: ica_reconstruct()"
ic, ic_mw = NeuroAnalyzer.ica(rand(10, 1000), n=5, tol=1.0)
...
@info "test 25/47: mutual_information()"
...
@info "test 27/47: pca_reconstruct()"
pc, pcv, pcm, pc_model = NeuroAnalyzer.pca(rand(4, 4, 2), n=2)
