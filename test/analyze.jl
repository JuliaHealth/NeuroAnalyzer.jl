...
@info "test 15/50: erp_peaks()"
e = NeuroAnalyzer.erp(e10)
p = NeuroAnalyzer.erp_peaks(e)
@test size(p) == (19, 2)

@info "test 16/50: fcoherence()"
...
@info "test 20/50: ica_reconstruct()"
ic, ic_mw = NeuroAnalyzer.ica(rand(10, 1000), n=5, tol=1.0)
...
@info "test 25/50: mutual_information()"
...
@info "test 27/50: pca_reconstruct()"
pc, pcv, pcm, pc_model = NeuroAnalyzer.pca(rand(4, 4, 2), n=2)
...
@info "test 49/50: amp_at()"
e = NeuroAnalyzer.erp(e10)
@test size(amp_at(e, t=2)) == (19, 123)

@info "test 50/50: avgamp_at()"
@test size(avgamp_at(e, t=(2, 2.5))) == (19, 123)
