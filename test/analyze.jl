...
@info "Test 15/61: erp_peaks()"
e = NeuroAnalyzer.erp(e10)
p = NeuroAnalyzer.erp_peaks(e)
@test size(p) == (23, 2)

@info "Test 16/61: coherence()"
...
@info "Test 25/61: mutual_information()"
...
@info "Test 46/61: pacor()"
pac, l = pacor(e10, l=2)
@test size(pac) == (23, 5, 10)
@test length(l) == 5

@info "Test 47/61: xcov()"
