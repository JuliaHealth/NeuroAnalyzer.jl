...
@info "Test 35/68: ci_median()"
@test ci_median(collect(1:100)) == (42, 59)

@info "Test 36/68: ci_r()"
...
@info "Test 56/68: bootstrap_stat()"
x = rand(10, 100)
s = bootstrap_stat(x, f="abs(maximum(OBJ))")
@test length(s) == 3000

@info "Test 57/68: seg_extract()"
x = ones(100, 100)
