...
@info "test 56/57: bootstrap_stat()"
x = rand(10, 100)
s = bootstrap_stat(x, f="abs(maximum(OBJ))")
@test length(s) == 3000

@info "test 57/57: seg_extract()"
x = ones(100, 100)
