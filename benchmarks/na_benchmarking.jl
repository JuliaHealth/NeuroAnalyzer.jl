...
import_nirx("test/files/nirx/NIRS-2020-08-18_001.hdr")
@time import_nirx("test/files/nirx/NIRS-2020-08-18_001.hdr")
...
xcov(e10, lag=10)
@time xcov(e10, lag=10)
print(rpad("Cross-covariance 2", 36))
xcov(e10, e10, ch1=1, ch2=2, ep1=1, ep2=2, lag=10)
@time xcov(e10, e10, ch1=1, ch2=2, ep1=1, ep2=2, lag=10)
print(rpad("Cross-correlation", 36))
x = xcorr(e10, e10, ch1=1, ch2=1, ep1=1, ep2=2)
@time xcorr(e10, e10, ch1=1, ch2=1, ep1=1, ep2=2)
