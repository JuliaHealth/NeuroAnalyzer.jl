...
print(rpad("Detrend: hp", 36))
detrend(e10, type=:hp)
@time detrend(e10, type=:hp)
...
print(rpad("CWT: sdwt", 36))
cw_trans(e10, wt=wavelet(Morlet(π), β=2))
@time cw_trans(e10, wt=wavelet(WT.haar), type=:sdwt)
print(rpad("CWT: acdwt", 36))
cw_trans(e10, wt=wavelet(Morlet(π), β=2))
@time cw_trans(e10, wt=wavelet(WT.haar), type=:acdwt)
...
e10_tmp=fconv(e10, kernel=generate_morlet(256, 1, 32, complex=true))
...
delete_channel!(edf_am, ch=[22, 23, 24])
e10_am = epoch(edf_am, ep_len=2560)
reference_a(e10_am)
@time reference_a(e10_am)
print(rpad("M referencing", 36))
edit_channel!(e10_am, ch=17, field=:labels, value="M1")
edit_channel!(e10_am, ch=18, field=:labels, value="M2")
reference_m(e10_am)
...
@time itpc_s(e10, ch=1, frq_lim=(10, 20), frq_n=11)
...
xcov(e10, e10, ch1=1, ch2=2, ep1=1, ep2=2, lag=10, demean=true)
@time xcov(e10, e10, ch1=1, ch2=2, ep1=1, ep2=2, lag=10, demean=true)
