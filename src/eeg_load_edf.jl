...
function eeg_load_edf(in_file, read_annotations=true, header_only=false, clean_labels=true)
    ...
    eeg = EEG(eeg_object_header, eeg_signal_header, eeg_time, eeg_signals)
