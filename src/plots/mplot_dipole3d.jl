...
"""
function mplot_dipole3d(d::NeuroAnalyzer.DIPOLE; project::Bool=true)

    _wip()

    # prepare meshes
    brain_top = Point3f[[-1.2, -1.2, 0.0],
                        [1.2, -1.2, 0.0],
                        [1.2, 1.2, 0.0],
                        [-1.2, 1.2, 0.0]]
    brain_top_uvs = Vec2f[(0, 0), (1, 0), (1, 1), (0, 1)]
    brain_top_fs = GLMakie.GLTriangleFace[(1, 2, 3), (1, 3, 4)]
    brain_top_mesh = GeometryBasics.Mesh(GeometryBasics.meta(brain_top,
                                                             brain_top_uvs,
...
=#
    ...
    brain_front = Point3f[[-1.2, 1.2, 0],
                          [-1.2, 1.2, 1.2],
                          [1.2, 1.2, 1.2],
                          [1.2, 1.2, 0]]
    brain_front_uvs = Vec2f[(0, 0), (1, 0), (1, 1), (0, 1)]
    brain_front_fs = GLMakie.GLTriangleFace[(1, 2, 3), (1, 3, 4)]
