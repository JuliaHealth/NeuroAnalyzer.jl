...
function plot_dipole3d(d::NeuroAnalyzer.DIPOLE; project::Bool=true)
    ...
    # prepare meshes
    brain_top_vertices = Point3f[
        (-1.2, -1.2, -0.1), (1.2, -1.2, -0.1), (1.2, 1.2, -0.1), (-1.2, 1.2, -0.1)
    ]
    brain_top_uvs = Vec2f[(0, 0), (1, 0), (1, 1), (0, 1)]
    brain_top_faces = [TriangleFace(1, 2, 3), TriangleFace(1, 3, 4)]
    brain_top_mesh = GeometryBasics.Mesh(
        brain_top_vertices, brain_top_faces; uv=brain_top_uvs
    )

    brain_side_vertices = Point3f[
        (-1.2, -1.2, -0.1), (-1.2, 1.2, -0.1), (-1.2, 1.2, 1.2), (-1.2, -1.2, 1.2)
    ]
    brain_side_uvs = Vec2f[(0, 0), (1, 0), (1, 1), (0, 1)]
    brain_side_faces = [TriangleFace(1, 2, 3), TriangleFace(1, 3, 4)]
    brain_side_mesh = GeometryBasics.Mesh(
        brain_side_vertices, brain_side_faces; uv=brain_side_uvs
    )

    brain_front_vertices = Point3f[
        (-1.2, 1.2, -0.1), (-1.2, 1.2, 1.2), (1.2, 1.2, 1.2), (1.2, 1.2, -0.1)
    ]
    brain_front_uvs = Vec2f[(0, 0), (1, 0), (1, 1), (0, 1)]
    brain_front_faces = [TriangleFace(1, 2, 3), TriangleFace(1, 3, 4)]
    brain_front_mesh = GeometryBasics.Mesh(
        brain_front_vertices, brain_front_faces; uv=brain_front_uvs
    )
