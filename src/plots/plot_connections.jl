...
"""
function plot_connections(locs::DataFrame; connections::Matrix{<:Real}, threshold::Real=0, threshold_type::Symbol=:neq, weights::Bool=true, ch::Union{Int64, Vector{Int64}}=1:nrow(locs), ch_labels::Bool=false, head::Bool=true, head_labels::Bool=false, mono::Bool=false, large::Bool=true, cart::Bool=false, plane::Symbol=:xy, title::String="")
...
function plot_connections(obj::NeuroAnalyzer.NEURO; connections::Matrix{<:Real}, threshold::Real=0, threshold_type::Symbol=:neq, weights::Bool=true, ch::Union{String, Vector{String}}=get_channel(obj, type=datatype(obj)), ch_labels::Bool=false, head::Bool=true, head_labels::Bool=false, mono::Bool=false, large::Bool=true, cart::Bool=false, plane::Symbol=:xy, title::String="")
    ...
    _check_channels(obj, labels(obj)[ch], datatype(obj))
