...
Plot single-channel continuous signal.
...
- `p::GLMakie.Figure`
"""
function plot_signal(t::Union{AbstractVector, AbstractRange}, s::AbstractVector; seg::Tuple{Real, Real}=(t[1], t[end]), xlabel::String="", ylabel::String="", title::String="", bad::Bool=false, gui::Bool=false)::Union{GLMakie.Figure, Nothing}
...
Plot multi-channel continuous signal.
...
- `p::GLMakie.Figure`
"""
function plot_signal(t::Union{AbstractVector, AbstractRange}, s1::AbstractVector, s2::AbstractVector; xlabel::String="", ylabel::String="", title::String="")::GLMakie.Figure
...
- `p::GLMakie.Figure`
"""
function plot_signal_avg(t::Union{AbstractVector, AbstractRange}, s::AbstractArray; xlabel::String="", ylabel::String="", title::String="", mono::Bool=false)::GLMakie.Figure
...
- `p::GLMakie.Figure`
"""
function plot_signal_butterfly(t::Union{AbstractVector, AbstractRange}, s::AbstractArray; clabels::Vector{String}=[""], xlabel::String="", ylabel::String="", title::String="", avg::Bool=true, mono::Bool=false)::GLMakie.Figure
...
- `p::GLMakie.Figure`
"""
function plot_signal(t::Union{AbstractVector, AbstractRange}, s1::AbstractArray, s2::AbstractArray; clabels::Vector{String}=string.(1:size(s, 1)), ctypes::Vector{String}=repeat([""], size(s1, 1)), cunits::Vector{String}=repeat([""], size(s1, 1)), xlabel::String="", ylabel::String="", title::String="", scale::Bool=true)::GLMakie.Figure
...
function plot(obj::NeuroAnalyzer.NEURO; ep::Int64=0, ch::Union{String, Vector{String}, Regex}="all", seg::Tuple{Real, Real}=(0, 10), xlabel::String="default", ylabel::String="default", title::String="default", mono::Bool=false, emarkers::Bool=true, markers::Bool=true, scale::Bool=true, type::Symbol=:normal, avg::Bool=true, bad::Bool=true, gui::Bool=true)::GLMakie.Figure
    ...
    if type === :normal
        if isa(ch, Int64)
            ...
            if ep == 0
                ...
                p = plot_signal(obj.time_pts[ep1:ep2],
                                obj.data[ch, :, ep],
                                seg=round.(Int64, seg),
                                xlabel=xl,
                                ylabel=yl,
    ...
    if type === :butterfly
        ...
        p = plot_signal_butterfly(obj.time_pts,
                                  obj.data[ch, :, :][:, :],
                                  clabels=clabels,
                                  xlabel=xl,
                                  ylabel=yl,
    ...
    if type === :mean
        ...
        xl, yl, tt = _set_defaults(xlabel,
                                   ...
                                   datatype(obj) == "eda" ? "Impedance [μS]" : "Amplitude [$(obj.header.recording[:unit][ch[1]])]",
                                   "$ch_n $(uppercase(unique(ctypes)[1])) channels")
        p = plot_signal_avg(obj.time_pts,
                            obj.data[ch, :, :][:, :],
                            xlabel=xl,
                            ylabel=yl,
                            title=tt,
...
- `p::GLMakie.Figure`
"""
function plot(obj1::NeuroAnalyzer.NEURO, obj2::NeuroAnalyzer.NEURO; ep::Union{Int64, AbstractRange}=0, ch::Union{String, Vector{String}, Regex}="all", seg::Tuple{Real, Real}=(0, 10), xlabel::String="default", ylabel::String="default", title::String="default", scale::Bool=true)::GLMakie.Figure
