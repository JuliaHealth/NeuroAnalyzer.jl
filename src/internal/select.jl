function _select_channels(
    obj::NeuroAnalyzer.NEURO, channel::Union{Int64, Vector{Int64}, AbstractUnitRange{Int64}},
    def_chn::Int64 = 0,
    ...
    isa(channel, AbstractUnitRange{Int64}) && (channel = collect(channel))
...
function _select_epochs(
    ...
    isa(epoch, AbstractUnitRange{Int64}) && (epoch = collect(epoch))
