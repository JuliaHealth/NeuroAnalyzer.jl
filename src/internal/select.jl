function _select_channels(
    obj::NeuroAnalyzer.NEURO, channel::Union{Int64, Vector{Int64}, AbstractRange}, def_chn::Int64 = 0
...
function _select_epochs(
    obj::NeuroAnalyzer.NEURO, epoch::Union{Int64, Vector{Int64}}, def_ep::Int64 = 0
)::Union{Int64, Vector{Int64}}
