...
function _create_recording_eeg(;
        data_type::String,
        file_name::String,
        file_size_mb::Real,
        file_type::String,
...
function _create_recording_seeg(;
        data_type::String,
        file_name::String,
        file_size_mb::Real,
        file_type::String,
...
function _create_recording_ecog(;
        data_type::String,
        file_name::String,
        file_size_mb::Real,
        file_type::String,
...
function _create_recording_sensors(;
        data_type::String,
        file_name::String,
        file_size_mb::Real,
        file_type::String,
...
function _create_recording_eda(;
        data_type::String,
        file_name::String,
        file_size_mb::Real,
        file_type::String,
