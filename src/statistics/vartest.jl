...
- `p::Array{Float64, 3}`
"""
function vartest(obj::NeuroAnalyzer.NEURO; ch::Union{String, Vector{String}})::NamedTuple{(:f, :p), Tuple{Array{Float64, 3}, Array{Float64, 3}}}
...
- `p::Array{Float64, 3}`
"""
function vartest(obj1::NeuroAnalyzer.NEURO, obj2::NeuroAnalyzer.NEURO; ch1::Union{String, Vector{String}}, ch2::Union{String, Vector{String}}, ep1::Union{Int64, Vector{Int64}, AbstractRange}=_c(nepochs(obj1)), ep2::Union{Int64, Vector{Int64}, AbstractRange}=_c(nepochs(obj2)))::NamedTuple{(:f, :p), Tuple{Array{Float64, 3}, Array{Float64, 3}}}
