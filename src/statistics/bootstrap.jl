...
"""
function bootstrap_ci(s::AbstractMatrix; n1::Int64=3000, n2::Int64=1000, ci::Float64=0.95)::NamedTuple{(:s_avg, :s_ci_l, :s_ci_h), Tuple{Vector{Float64}, Vector{Float64}, Vector{Float64}}}
