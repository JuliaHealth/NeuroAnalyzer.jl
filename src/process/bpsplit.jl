...
"""
function bpsplit(obj::NeuroAnalyzer.NEURO; ch::Union{String, Vector{String}}, order::Int64=8, w::Union{Nothing, AbstractVector, <:Real}=nothing)::NamedTuple{(:s, :bn, :bf), Tuple{Array{Float64, 4}, Vector{Symbol}, Vector{Tuple{Real, Real}}}}
