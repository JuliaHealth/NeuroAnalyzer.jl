...
- `channel::Union{Int64, Vector{Int64}, AbstractRange}=get_channel_bytype(obj, type=Symbol(obj.header.recording[:data_type]))`: index of channels, default is all OBJ channels
