...
"""
function ispc(s1::AbstractVector, s2::AbstractVector)::NamedTuple{(:ispc_val, :ispc_ang, :s_diff, :ph_diff, :s1_phase, :s2_phase), Tuple{Float64, Float64, Vector{Float64}, Vector{Float64}, Vector{Float64}, Vector{Float64}}}
...
"""
function ispc(obj::NeuroAnalyzer.NEURO; ch::Union{String, Vector{String}})::NamedTuple{(:ispc_val, :ispc_ang), Tuple{Array{Float64, 3}, Array{Float64, 3}}}
...
"""
function ispc(obj1::NeuroAnalyzer.NEURO, obj2::NeuroAnalyzer.NEURO; ch1::Union{String, Vector{String}}, ch2::Union{String, Vector{String}}, ep1::Union{Int64, Vector{Int64}, <:AbstractRange}=_c(nepochs(obj1)), ep2::Union{Int64, Vector{Int64}, <:AbstractRange}=_c(nepochs(obj2)))::NamedTuple{(:ispc_val, :ispc_ang, :s_diff, :ph_diff, :s1_phase, :s2_phase), Tuple{Matrix{Float64}, Matrix{Float64}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}}}
