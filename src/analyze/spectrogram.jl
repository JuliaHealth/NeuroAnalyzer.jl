...
"""
function spectrogram(s::AbstractVector; fs::Int64, db::Bool=true, method::Symbol=:stft, nt::Int64=7, wlen::Int64=fs, woverlap::Int64=round(Int64, wlen * 0.97), w::Bool=true)::NamedTuple{(:p, :f, :t), Tuple{Matrix{Float64}, Vector{Float64}, Vector{Float64}}}
...
- `t::Vector{Float64}`: time
"""
function mwspectrogram(s::AbstractVector; pad::Int64=0, db::Bool=true, fs::Int64, ncyc::Union{Int64, Tuple{Int64, Int64}}=32, w::Bool=true)::NamedTuple{(:cs, :p, :ph, :f, :t), Tuple{Matrix{ComplexF64}, Matrix{Float64}, Matrix{Float64}, Vector{Float64}, Vector{Float64}}}
...
- `t::Vector{Float64}`: time
"""
function ghspectrogram(s::AbstractVector; fs::Int64, db::Bool=true, gw::Real=5, w::Bool=true)::NamedTuple{(:p, :ph, :f, :t), Tuple{Matrix{Float64}, Matrix{Float64}, Vector{Float64}, Vector{Float64}}}
...
- `t::Vector{Float64}`: time
"""
function cwtspectrogram(s::AbstractVector; fs::Int64, wt::T=wavelet(Morlet(2π), β=32, Q=128), norm::Bool=true)::NamedTuple{(:p, :f, :t), Tuple{Matrix{Float64}, Vector{Float64}, Vector{Float64}}} where {T <: CWT}
