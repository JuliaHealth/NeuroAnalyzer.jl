...
include("analyze/frequency/band_asymmetry.jl")
include("analyze/frequency/band_mpower.jl")
include("analyze/frequency/band_power.jl")
include("analyze/frequency/coherence.jl")
include("analyze/frequency/cpsd.jl")
include("analyze/frequency/erop.jl")
include("analyze/frequency/eros.jl")
include("analyze/frequency/frqinst.jl")
include("analyze/frequency/hjorth.jl")
include("analyze/frequency/peak_frq.jl")
include("analyze/frequency/psd.jl")
include("analyze/frequency/psd_rel.jl")
include("analyze/frequency/psd_slope.jl")
include("analyze/frequency/sef.jl")
include("analyze/frequency/spectrogram.jl")
include("analyze/frequency/spectrum.jl")
include("analyze/frequency/total_power.jl")
include("analyze/mep/mep_peaks.jl")
include("analyze/misc/corm.jl")
include("analyze/misc/covm.jl")
include("analyze/misc/dissimilarity.jl")
include("analyze/misc/entropy.jl")
include("analyze/misc/envelopes.jl")
include("analyze/misc/ged.jl")
include("analyze/misc/hrv.jl")
include("analyze/misc/mi.jl")
include("analyze/misc/stationarity.jl")
include("analyze/misc/tkeo.jl")
include("analyze/phase/cph.jl")
include("analyze/phase/ispc.jl")
include("analyze/phase/itpc.jl")
include("analyze/phase/phdiff.jl")
include("analyze/phase/phsd.jl")
include("analyze/phase/pli.jl")
include("analyze/time/acor.jl")
include("analyze/time/acov.jl")
include("analyze/time/axc2frq.jl")
include("analyze/time/pacor.jl")
include("analyze/time/xcor.jl")
include("analyze/time/xcov.jl")
# edit
