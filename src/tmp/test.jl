...
# ╔═╡ 015f3c81-4311-4fcf-8a9d-f3f03b80710a
using PlutoUI

# ╔═╡ 2d638538-7949-4b94-a730-e5e7f77520ef
using Plots

# ╔═╡ e4965690-3ca2-11ed-31fa-b7a165661607
x = Vector{Int64}()

# ╔═╡ 256b74c5-be95-4fbe-aa18-f1c54f50dbc5
y = 1:100
...
# ╔═╡ d0d62f56-7715-4525-b2c0-a4ad506c8d49
@show y[options.idx]

# ╔═╡ 7e848509-f3da-4c30-b84e-76ff0cd8a5d7
begin
	options.del && push!(x, options.idx)
	unique!(sort!(x))
	@show x
end
