...
function eeg_info(eeg::NeuroAnalyzer.EEG)
    ...
    println("            Source file: $(eeg.eeg_header[:eeg_filename])")
    println("                Subject: $(eeg.eeg_header[:patient])")
    println("                   Note: $(eeg.eeg_header[:note])")
    println("              Recording: $(eeg.eeg_header[:recording])")
    println("         Recording date: $(eeg.eeg_header[:recording_date])")
    println("         Recording time: $(eeg.eeg_header[:recording_time])")
