...
plot_save(p, file_name="images/eeg_bands.png")
```
...
plot_save(p, file_name="images/eeg_rel_psd.png")
```
...
plot_save(p, file_name="images/e10_tconv_phases.png")
```
...
plot_save(p, file_name="images/eeg_amp.png")
```
...
plot_save(p, file_name="images/eeg_topos.png")
```
...
plot_save(p, file_name="images/eeg_1_5.png")
p = eeg_plot(eeg, pc, c_idx=1:5, segment=(10*eeg_sr(eeg), 20*eeg_sr(eeg)))
plot_save(p, file_name="images/eeg_pca_1_5.png")
bar(vec(pc_var))
```
...
plot_save(p, file_name="images/eeg_ica_1_10.png")
```
...
plot_save(p, file_name="images/eeg_alpha_topo.png")
```
...
plot_save(p, file_name="images/eeg_phdiff_topo.png")
```
...
plot_save(p, file_name="images/eeg_ampdiff_topo.png")
```
...
plot_save(p, file_name="images/eeg_weights.png")
```
...
plot_save(p, file_name="images/eeg_cov.png")
```
...
plot_save(p, file_name="images/eeg_autocov.png")
```
...
plot_save(p, file_name="images/eeg_xcov.png")
```
...
plot_save(p, file_name="images/e10_ispc.png")
m = eeg_ispc(e10)
p = plot_matrix(m[:, :, 1], labels_x=eeg_labels(e10), labels_y=eeg_labels(e10))
plot_save(p, file_name="images/e10_ispc_m.png")
p = eeg_plot_connections(e10, m=m[:, :, 1], threshold=0.90, threshold_type=:geq)
plot_save(p, file_name="images/e10_ispc_connections.png")
```
...
plot_save(p, file_name="images/e10_itpc.png")
p = eeg_plot_itpc_s(e10, channel=1, frq_lim=(1, 20), frq_n=20)
plot_save(p, file_name="images/e10_itpc_s.png")
...
plot_save(p, file_name="images/e10_pli.png")

m = eeg_pli(e10)
p = plot_matrix(m[:, :, 1], labels_x=eeg_labels(e10), labels_y=eeg_labels(e10))
plot_save(p, file_name="images/e10_pli_m.png")
```
...
plot_save(p, file_name="images/h_connections.png")
```
...
plot_save(p, file_name="images/kwargs.png")
```
...
plot_save(p, file_name="images/spec_seg.png")
...
plot_save(p, file_name="images/spec_seg_box.png")
```
![](images/spec_seg.png)
