...
print(rpad("DWT: standard", 36))
dw_trans(e10, ch="all", type=:standard)
@time dw_trans(e10, ch="all", type=:standard)
print(rpad("DWT: sdwt", 36))
dw_trans(e10, ch="all", type=:sdwt)
@time dw_trans(e10, ch="all", type=:sdwt)
print(rpad("DWT: acdwt", 36))
dw_trans(e10, ch="all", type=:acdwt)
@time dw_trans(e10, ch="all", type=:acdwt)
print(rpad("CWD", 36))
cwd(e10, ch="all")
@time cwd(e10, ch="all")
