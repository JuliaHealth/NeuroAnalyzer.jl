...
import_fiff(joinpath(testfiles_path, "meg-test-fiff.fiff"))
@time import_fiff(joinpath(testfiles_path, "meg-test-fiff.fiff"))
...
dwtsplit(e10, ch="all" ch="F3", wt=wavelet(WT.db2), type=:sdwt, n=5)
@time dwtsplit(e10, ch="all", ch="F3", wt=wavelet(WT.db2), type=:sdwt, n=5)
...
lrinterpolate_channel(e10, ch="all", ch="F3", ep=1)
@time lrinterpolate_channel(e10, ch="all", ch="F3", ep=1)
print(rpad("Interpolate: PL", 36))
plinterpolate_channel(e10, ch="all", ch="F3", ep=1)
@time plinterpolate_channel(e10, ch="all", ch="F3", ep=1)
print(rpad("Normalize", 36))
NeuroAnalyzer.normalize(e10, ch="all", method=:zscore)
@time NeuroAnalyzer.normalize(e10, method=:zscore)
...
@time frqinst(e10)
print(rpad("GED", 36))
ged(e10, e10, ch1=["F3", "F4"], ch2=:5:8, ep1=1:10, ep2=11:20)
@time ged(e10, e10, ch1=["F3", "F4"], ch2=:5:8, ep1=1:10, ep2=11:20)
...
psd(e10, method=:gh)
@time psd(e10, method=:gh)
print(rpad("PSD: cwt", 36))
psd(e10, method=:cwt)
@time psd(e10, method=:cwt)
