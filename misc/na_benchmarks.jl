...
band_power(e10, f=(10, 20), method=:fft)
@time band_power(e10, f=(10, 20), method=:fft)
print(rpad("Band power: stft", 36))
band_power(e10, f=(10, 20), method=:stft)
@time band_power(e10, f=(10, 20), method=:stft)
print(rpad("Band power: mt", 36))
band_power(e10, f=(10, 20), method=:mt)
@time band_power(e10, f=(10, 20), method=:mt)
print(rpad("Band power: mw", 36))
band_power(e10, f=(10, 20), method=:mw)
@time band_power(e10, f=(10, 20), method=:mw)
print(rpad("Band mpower: welch", 36))
band_mpower(e10, f=(10, 20))
@time band_mpower(e10, f=(10, 20))
print(rpad("Band mpower: fft", 36))
band_mpower(e10, f=(10, 20), method=:fft)
@time band_mpower(e10, f=(10, 20), method=:fft)
print(rpad("Band mpower: stft", 36))
band_mpower(e10, f=(10, 20), method=:stft)
@time band_mpower(e10, f=(10, 20), method=:stft)
print(rpad("Band mpower: mt", 36))
band_mpower(e10, f=(10, 20), method=:mt)
@time band_mpower(e10, f=(10, 20), method=:mt)
print(rpad("Band mpower: mw", 36))
band_mpower(e10, f=(10, 20), method=:mw)
@time band_mpower(e10, f=(10, 20), method=:mw)
...
print(rpad("Coherence: FTT", 36))
coherence(e10, e10, ch1=1, ch2=2, ep1=1, ep2=2, method=:ftt)
@time coherence(e10, e10, ch1=1, ch2=2, ep1=1, ep2=2, method=:ftt)
print(rpad("TKEO", 36))
tkeo(e10)
@time tkeo(e10)
