...
average(e10, e10, ch1="F3", ch2="F4", ep1=1, ep2=1)
@time average(e10, e10, ch1="F3", ch2="F4", ep1=1, ep2=1)
print(rpad("CBP", 36))
...
dwtsplit(e10, ch="all", wt=wavelet(WT.db2), type=:sdwt, n=5)
@time dwtsplit(e10, ch="all", wt=wavelet(WT.db2), type=:sdwt, n=5)
...
lrinterpolate_channel(e10, ch="all", ep=1)
@time lrinterpolate_channel(e10, ch="all", ep=1)
print(rpad("Interpolate: PL", 36))
plinterpolate_channel(e10, ch="all", ep=1)
@time plinterpolate_channel(e10, ch="all", ep=1)
...
tconv(e10, ch="all", kernel=generate_morlet(256, 1, 32, complex=true))
@time tconv(e10, ch="all", kernel=generate_morlet(256, 1, 32, complex=true))
