...
println(
    "CPU: $(Sys.cpu_info()[1].model) $(length(Sys.cpu_info()) ÷ 2) cores ($(round(Sys.cpu_info()[1].speed / 1024, digits=2)) GHz)",
)
println(
    "RAM: $(round((Int64(Sys.free_memory())) / 1024^3, digits=1)) GB free / $(round((Int64(Sys.total_memory())) / 1024^3, digits=1)) GB",
)
println()
...
load_locs!(
    e10;
    file_name = joinpath(NeuroAnalyzer.PATH, "locs", "standard-10-20-cap19-elmiko.ced"),
)
...
band_power(e10; ch = "all", flim = (10, 20))
@time band_power(e10, ch = "all", flim = (10, 20))
print(rpad("Band power: FFT", 36))
band_power(e10; ch = "all", flim = (10, 20), method = :fft)
@time band_power(e10, ch = "all", flim = (10, 20), method = :fft)
print(rpad("Band power: STFT", 36))
band_power(e10; ch = "all", flim = (10, 20), method = :stft)
@time band_power(e10, ch = "all", flim = (10, 20), method = :stft)
print(rpad("Band power: MT", 36))
band_power(e10; ch = "all", flim = (10, 20), method = :mt)
@time band_power(e10, ch = "all", flim = (10, 20), method = :mt)
print(rpad("Band power: MW", 36))
band_power(e10; ch = "all", flim = (10, 20), method = :mw)
@time band_power(e10, ch = "all", flim = (10, 20), method = :mw)
print(rpad("Band mpower: Welch", 36))
band_mpower(e10; ch = "all", flim = (10, 20))
@time band_mpower(e10, ch = "all", flim = (10, 20))
print(rpad("Band mpower: FFT", 36))
band_mpower(e10; ch = "all", flim = (10, 20), method = :fft)
@time band_mpower(e10, ch = "all", flim = (10, 20), method = :fft)
print(rpad("Band mpower: STFT", 36))
band_mpower(e10; ch = "all", flim = (10, 20), method = :stft)
@time band_mpower(e10, ch = "all", flim = (10, 20), method = :stft)
print(rpad("Band mpower: MT", 36))
band_mpower(e10; ch = "all", flim = (10, 20), method = :mt)
@time band_mpower(e10, ch = "all", flim = (10, 20), method = :mt)
print(rpad("Band mpower: MW", 36))
band_mpower(e10; ch = "all", flim = (10, 20), method = :mw)
@time band_mpower(e10, ch = "all", flim = (10, 20), method = :mw)
...
itpc_spec(e10; ch = "F3", flim = (10, 20), frq_n = 11)
@time itpc_spec(e10, ch = "F3", flim = (10, 20), frq_n = 11)
...
psd_rel(e10; ch = "all", flim = (10, 20))
@time psd_rel(e10, ch = "all", flim = (10, 20))
